...
collection_name = ""    ### MENTION THE NAME OF THE COLLECTION
...
client = InferenceClient(model="meta-llama/Meta-Llama-3-8B-Instruct", token="") ### SPECIFY YOUR HUGGINGFACE API KEY HERE ###

with open(multi_file_path, 'r') as file:
    multi_data = json.load(file)

for document in tqdm(multi_data, desc="Processing documents"):
