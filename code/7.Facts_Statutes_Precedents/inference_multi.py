...
with open(output_csv_file, 'a', newline='', encoding='utf-8') as f:
    ...
    for i, row in tqdm(df.iterrows(), total=df.shape[0]):
        ...
        1. Facts: The core facts of the case.  
        ...
        ##PREDICTION: 1  
        ##EXPLANATION: The appeal is accepted because the employer violated the contractual obligation to provide a 30-day notice. The cited case establishes precedent that unjustified termination breaches contractual rights, further supported by statutory law.
